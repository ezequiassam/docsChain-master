...
class Documento(db.Model):
    """
    Objeto para manipulação dos documentos

    :param filename: nome original do arquivo
    :param base64orig: base64 do documento original
    :param base64plot: base64 do documento já plotado
    :param chain: código (previos hash) do bloco gerado da blockchain
    ...
    id = db.Column('documento_id', db.Integer, primary_key=True)
    filename = db.Column(db.String)
    base64orig = db.Column(db.String)
    base64plot = db.Column(db.String)
    ...
    def toDict(self):
        return {
            ...
            'base64orig': self.base64orig,
            'base64plot': self.base64plot,
            'chain': self.chain,
            'sha': self.sha,
